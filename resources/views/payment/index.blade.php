...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="pull-left page-title"><i class="fa fa-money"></i> {{__('page.payment_management')}}</h3>
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{route('home')}}">{{__('page.home')}}</a></li>
                        <li>{{__('page.payment')}}</li>
                ...
                <div class="card-body table-responsive mt-2">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3 text-right">
                            ...
                            @elseif($type == 'sale')
                                @if(in_array($role, ['admin', 'user']))
                                    <a href="{{route('sale.create')}}" class="btn btn-primary mr-3">{{__('page.add_sale')}}</a>
                                @endif
                                <a href="{{route('sale.index')}}" class="btn btn-success mg-r-30">{{__('page.sales_list')}}</a>
                            @endif
                        </div>
                    </div>
                </div>                
